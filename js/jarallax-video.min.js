...
!(function (e, t) {
   ...
   class d {
       constructor(e, t) {
           const o = this;
           (o.url = e),
               (o.options_default = { autoplay: !1, loop: !1, mute: !1, volume: 100, showControls: !0, accessibilityHidden: !1, startTime: 0, endTime: 0 }),
               (o.options = o.extend({}, o.options_default, t)),
               void 0 !== o.options.showContols && ((o.options.showControls = o.options.showContols), delete o.options.showContols),
       ...
       play(e) {
           const o = this;
           o.player &&
               ("youtube" === o.type && o.player.playVideo && (void 0 !== e && o.player.seekTo(e || 0), t.YT.PlayerState.PLAYING !== o.player.getPlayerState() && o.player.playVideo()),
               "vimeo" === o.type &&
       ...
       pause() {
           const e = this;
           e.player &&
               ("youtube" === e.type && e.player.pauseVideo && t.YT.PlayerState.PLAYING === e.player.getPlayerState() && e.player.pauseVideo(),
               "vimeo" === e.type &&
           ...
           o.$video
               ...
               : o.onAPIready(() => {
                     ...
                     if ((o.$video || ((i = document.createElement("div")), (i.style.display = "none")), "youtube" === o.type)) {
                         let e, a;
                         (o.playerOptions = { host: "https://www.youtube-nocookie.com", videoId: o.videoID, playerVars: { autohide: 1, rel: 0, autoplay: 0, playsinline: 1 } }),
                             ...
                             (o.playerOptions.events = {
                                 onReady(e) {
                                     if (
                                         (o.options.mute ? e.target.mute() : o.options.volume && e.target.setVolume(o.options.volume),
                         ...
                         (o.player = o.player || new t.YT.Player(o.playerID, o.playerOptions)),
                             n &&
                                 ...
                                 o.options.accessibilityHidden && (o.$video.setAttribute("tabindex", "-1"), o.$video.setAttribute("aria-hidden", "true")),
                                 (o.videoWidth = parseInt(o.$video.getAttribute("width"), 10) || 1280),
                                 (o.videoHeight = parseInt(o.$video.getAttribute("height"), 10) || 720));
                     }
                     if ("vimeo" === o.type) {
                         if (
                             ((o.playerOptions = { dnt: 1, id: o.videoID, autopause: 0, transparent: 0, autoplay: o.options.autoplay ? 1 : 0, loop: o.options.loop ? 1 : 0, muted: o.options.mute ? 1 : 0 }),
                             o.options.volume && (o.playerOptions.volume = o.options.volume),
                             o.options.showControls || ((o.playerOptions.badge = 0), (o.playerOptions.byline = 0), (o.playerOptions.portrait = 0), (o.playerOptions.title = 0), (o.playerOptions.background = 1)),
                             !o.$video)
                         ) {
                             let e = "";
           ...
           if ((e.options.onVideoWorkerInit && e.options.onVideoWorkerInit.call(e, o), o.isValid()))
               if ((this.options.disableParallax() && ((t = !0), (e.image.position = "absolute"), (e.options.type = "scroll"), (e.options.speed = 1)), t)) {
                   if (
                       ...
                       (e.video = o),
                       !e.defaultInitImgResult && ((e.image.src = "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"), "local" !== o.type))
                   )
                       return (
                           o.getImageURL((t) => {
   ...
   return (
       ...
       "complete" === document.readyState || "interactive" === document.readyState ? y() : document.addEventListener("DOMContentLoaded", y, { capture: !0, once: !0, passive: !0 }),
